...
--Таблицадан машиналардын бренд, модель жана бааларын чыгарыныз
select brand,model,price from cars;
-- Таблицадан бардык машиналардын санын чыгарыныз
...
select * from cars where  brand like ('Chevrolet') ;
...
select  avg(cars.year_of_issue) as evera_year from cars;
...
select * from cars where brand in ('Audi','Toyota','Ford');
...
-- select * from cars where year_of_issue offset 1995  limit 2005;
